...
RSpec.describe Reports::IrsVerificationReport do
  ...
  before do
    ...
    allow_any_instance_of(Reports::IrsVerificationReport).to receive(:bucket_name).and_return('test-bucket')
    allow_any_instance_of(Reports::IrsVerificationReport).to receive(:upload_file_to_s3_bucket).and_return(true)
